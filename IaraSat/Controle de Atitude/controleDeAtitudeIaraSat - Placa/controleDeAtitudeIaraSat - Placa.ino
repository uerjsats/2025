...
// ------- PINS DO HARDWARE -------
// ===========================================
#define IN1 10            // Pino de controle 1 do driver de motor (PWM)
#define IN2 11            // Pino de controle 2 do driver de motor (PWM)
#define LDRVERMELHO A0  // Sensor LDR 0 (Analog 0), Direita
#define LDRAZUL A1      // Sensor LDR 1 (Analog 1), Esquerda
#define SWANT1 7 // Switch de antena 1
#define SWANT2 8 // Switch
#define ANTIN1 9 // IN1 da Antena
#define ANTIN2 6 // IN2 da Antena
// ------------------------------
